...
tMatrix cCharacter::BuildOriginTrans0() const
{
	// std::cout << mPose0 << std::endl;
	return cKinTree::BuildOriginTrans(mJointMat, mPose0);
}
...
tMatrix  cCharacter::GetJointLocalTrans(int joint_id) const
{
	return cKinTree::GetJointRotation(mJointMat, mPose, joint_id);
}
tMatrix cCharacter::BuildJointLocalTrans(int joint_id) const
{
	return cKinTree::ChildParentTrans(mJointMat, mPose, joint_id);
}
