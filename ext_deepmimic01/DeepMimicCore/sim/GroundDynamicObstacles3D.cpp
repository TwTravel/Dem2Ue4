...
bool cGroundDynamicObstacles3D::ParseParamsJson(const Json::Value& json, Eigen::VectorXd& out_params)
{
...
{
	return static_cast<int>(cGround::eParamsMax);
}
...
{
	int num_obstacles = static_cast<int>(mBlendParams[cGround::eParamsNumObstacles]);
	mObstacles.clear();
