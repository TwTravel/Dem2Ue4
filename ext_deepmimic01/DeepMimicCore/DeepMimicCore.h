...
public:
	...
	virtual std::vector<double> RecordGround(int agent_id) const;
	...
	virtual void SetGoal(int agent_id, const std::vector<double>& goal);
	virtual void AddForce(int agent_id, int part_idx, double force, const std::vector<double>& direction, double duration);
