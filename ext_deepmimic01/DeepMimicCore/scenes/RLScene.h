...
public:
	...
	virtual void RecordGround(int agent_id, Eigen::VectorXd& out_state) const = 0;
	...
	virtual void SetGoal(int agent_id, const Eigen::VectorXd& goal){};
	virtual void AddForce(int agent_id, int part_idx, double force, tVector direction, double time_step){};
