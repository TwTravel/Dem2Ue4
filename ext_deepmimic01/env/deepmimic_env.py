...
class DeepMimicEnv(Env):
    def __init__(self, args, enable_draw):
        ...
        self._core.Init()
        # self._core.SetGoal(0, [2.0, 1.0, 0.5])
        return
    ...
    def reset(self):
        ...
        # self._core.AddForce(0, 1, 1000.0, [-1, 0, 0], 0.1)
    ...
    def record_goal(self, agent_id):
        ...
        # return np.array(self._core.RecordGround(agent_id))

    def record_ground(self, agent_id):
        return np.array(self._core.RecordGround(agent_id))
    ...
    def set_goal(self, agent_id, goal):
        return self._core.SetGoal(agent_id, goal.tolist())
