...
# cmd = '--arg_file args/kin_char_ext_args.txt'
cmd = '--arg_file args/run_humanoid3d_ext_run_args.txt' #run_humanoid3d_walk_args_02.txt'
# cmd = '--arg_file args/train_humanoid3d_walk_args_02.txt'
